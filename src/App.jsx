        ...
        <div className={`App ${!dark ? "App" : "App_1"}`} >
          ...
          {auth.user && (<>
            ...
            {auth.user.role === 'admin' ? (<>
              <Route path="/admin-dashboard" element={<Dashboard dark={dark} />}/>
            <Route path="/admin-users" element={<AllUsers dark={dark} />}/>
            <Route path="/admin-products" element={<FoodProducts dark={dark} />}/>
            <Route path="/admin-chart" element={<AdminChart dark={dark} />}/>
            <Route path="/admin-payment" element={<Payments dark={dark} />}/>
